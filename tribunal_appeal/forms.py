...
from .models import *
class Recommend_Appeal_Action_Form(forms.ModelForm):
    class Meta:
        model = Appellate_Order_Details
        fields = 'order','issue','demand','admitted_tax','disputed_tax','reco_reason','is_disputed','is_recommended'

        widgets={
            'order': forms.Select(attrs={'class':'form-control'}),            
            'issue':forms.Select(attrs={'class':'form-control'}),            
            'demand':forms.NumberInput(attrs={'class':'form-control'}),
            'admitted_tax':forms.NumberInput(attrs={'class':'form-control'}),
            'disputed_tax':forms.NumberInput(attrs={'class':'form-control'}),
            'reco_reason':forms.TextInput(attrs={'class':'form-control'}),
...
class Approve_Appeal_Actions_Form(forms.ModelForm):
     class Meta:
        model = Appellate_Order_Details
        fields = 'order','issue','demand','admitted_tax','disputed_tax','reco_reason','approval_reason','is_disputed','is_recommended','is_approved',
...
class Draft_Tribunal_Appeal_Form(forms.ModelForm):
    class Meta:
        model = Tribunal_Appeal_Draft
...
class As_Filed_Tribunal_Appeal_Form(forms.ModelForm):
    class Meta:
        model = Tribunal_Appeal_Final
...
class Tribunal_Appeal_Hearing_Form(forms.ModelForm):     
    class Meta:
        model = Tribunal_Appeal_Hearing
...
class Trinunal_Order_Form(forms.ModelForm):
    class Meta:
        model = Tribunal_Order
...
class Tribunal_Order_Details_Form(forms.ModelForm):
    class Meta:
        model =Tribunal_Order_Details
